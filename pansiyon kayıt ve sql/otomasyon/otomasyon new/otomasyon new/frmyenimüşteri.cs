...
namespace otomasyon_new
{
    public partial class frmyenimüşteri : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source= DESKTOP-6M7OB2I;Initial Catalog=DAĞHAN PANSİYON;Integrated Security=True");


//DESKTOP-SBG9EFS
        //burdaki kodda oda butonunun textine 101 yazdırıp txt adi ve txt soyadı na yazılan değeri sql deki adi ve soyadina aktarır
        //
        ...
        {
            MessageBox.Show("Kırmızı renkli butonlar dolu odaları gösteriri");
        }
        ...
        private void DtpçikişTarihi_ValueChanged(object sender, EventArgs e)
        {
            int Ucret;
        ...
        private void frmyenimüşteri_Load(object sender, EventArgs e)
        {
            ...
            while (oku9.Read())
            {
                BtnOda108.Text = oku9["Adi"].ToString() + " " + oku9["Soyadi"].ToString();
            }
            baglanti.Close();
